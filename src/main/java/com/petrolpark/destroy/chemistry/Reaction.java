...
public class Reaction {
    ...
    public static ReactionBuilder generatedReactionBuilder() {
        return new ReactionBuilder(new Reaction("novel"), true, false);
    };
    ...
    protected Reaction(String nameSpace) {
    ...
    /**
     * Get the {@link Reaction#standardHalfCellPotential standard half cell potential} of this reduction half-Reaction.
    ...
    /**
     * Get the {@link Reaction#electrons transferred} in this reduction half-Reaction.
    ...
    public static class ReactionBuilder {
        ...
        private ReactionBuilder(Reaction reaction, boolean generated, boolean declaredAsReverse) {
        ...
        public ReactionBuilder(String namespace) {
            this(new Reaction(namespace), false, false);
            this.namespace = namespace;
        };
        ...
        public ReactionBuilder reverseReaction(Consumer<ReactionBuilder> reverseReactionModifier) {
            ...
            reaction.displayAsReversible = true;
            ReactionBuilder reverseBuilder = new ReactionBuilder(new Reaction(namespace), false, true);
    ...
    public static class RedoxReaction extends Reaction {
