...
public class DestroyGroupTypes {
    ...
    public static GroupType<SaturatedCarbonGroup> ALKENE = new GroupType<>(() -> DestroyMolecules.GENERIC_ALKENE);
    public static GroupType<SaturatedCarbonGroup> ALKYNE = new GroupType<>(() -> DestroyMolecules.GENERIC_ALKYNE);
