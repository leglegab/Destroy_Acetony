 ...
 * <p>A sealed bottle containing water and oil would have three {@link IPhase}s - the water, the oil and the air.
 * Like a {@link IMixture}, {@link IPhase}s are not defined in terms of a specific volume. </p>
 * <p>{@link IPhase}s exist in a certain {@link IState}, which may change.</p>
 * @since Destroy 0.1.0
 * @author petrolpark
 */
public interface IPhase<C extends IMixtureComponent> extends IMixture<C>, IHeatable, ITemperature, IPressure, IDensity {
    ...
    /**
     * The {@link IState} of this {@link IPhase}.
     * @since Destroy 0.1.0
     * @author petrolpark
     */
