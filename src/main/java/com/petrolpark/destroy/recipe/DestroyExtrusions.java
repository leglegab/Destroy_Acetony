...
import com.petrolpark.destroy.block.StainlessSteelRodsBlock;
...
public class DestroyExtrusions {
    ...
    public static void register() {
        ...
        BlockExtrusion.register(DestroyBlocks.MOLTEN_STAINLESS_STEEL.get(), (state, direction) -> DestroyBlocks.STAINLESS_STEEL_RODS.getDefaultState().setValue(BlockStateProperties.AXIS, direction.getAxis()).setValue(StainlessSteelRodsBlock.MOLTEN, true));
